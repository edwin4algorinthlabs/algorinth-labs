  ...
  return (
    <div className="h-screen relative z-0 w-full bg-[#08111F] bg-[url('/images/coming.png')] bg-contain bg-no-repeat bg-center">
      ...
      <div className="w-full absolute z-10 bottom-[3.14%] flex justify-center">
        <div className="max-w-[48%] w-full flex flex-row h-[72.1px] rounded-[10px] bg-white ">
      ...
      {/* Balls */}
      <div className="fixed top-[34.5%] left-[-40%] z-[1] w-[50.85%] h-[68.2%] rounded-full gradient1"></div>
      <div className="flex flex-col justify-center gap-6 fixed top-[34.5%] right-[-40%] z-[1] w-[50.85%] h-[68.2%] rounded-full gradient2 pl-[92px]">
