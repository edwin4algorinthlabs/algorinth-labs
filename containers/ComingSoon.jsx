...
export default function ComingSoonContainer() {
  return (
    <div className="h-screen relative z-0 w-full bg-[#08111F] bg-[url('/images/coming.png')] bg-contain bg-no-repeat bg-center  overflow-hidden">
      ...
      {/* Balls */}
      <div className="absolute bottom-[-30px] left-[-533px] z-[1] w-[754px] h-3/4 rounded-full gradient1"></div>
      <div className="flex flex-col justify-center gap-6 absolute bottom-[-30px] right-[-533px] z-[1] w-[754px] h-3/4 rounded-full gradient2 pl-[92px]">
