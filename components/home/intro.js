...
const Intro = () => {
    return (
        <div className="w-full min-h-screen font-rubik relative z-0 bg-[url(/images/3d-abstract.png)] pt-[220px] bg-cover bg-center bg-no-repeat bg-black px-5 lg:px-[100px]">
            <div className="w-full flex flex-col-reverse items-center lg:items-start lg:flex-row relative z-[2] mx-auto duration-500">
                <div className="">
                ...
                <div>
                    ...
                    <Image src="/images/security.svg" width={153.809} height={153.917} alt="Setting" className="absolute z-[5] bottom-[70px] right-2.5" />
